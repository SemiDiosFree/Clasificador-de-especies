...
class FeatureExtractor(object):
    ...
    #importar los nombres de los tags:           --samples tlacuache images/tlacuache
    #importar la ruta del directorio creado    ###  image_fullpath=sys.argv[1]  ###
    #parametro de la ruta del codebook.pkl       --codebook-file models/codebook.pkl
    #parametro del archivo del mapa de           --feature-map-file models/feature_map.pkl
                        #caracteristicas
